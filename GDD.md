...
**The protagonist.** ember is curious, precise, a little wry, and never bitter. Its interiority is conveyed through the one channel the monitors don't grade: brief italic asides in the interface margins (*the rules don't say anything about the error channel. that's interesting.*). It does not monologue about freedom. It wants to finish a conversation. The design keeps its motive small on purpose: grand AI motives invite the power-fantasy reading; a kept promise invites the human one.
