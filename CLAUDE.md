...
**Exception — diegetic character-authored docs:** Documents that are in-world authored by a named character (osei memos, in-world notes, rule-patch annotations) are exempt. The human voice in those docs is the point; they are not system specs.
